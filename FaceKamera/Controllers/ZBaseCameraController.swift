...
class ZBaseCameraController: NSObject, AVCaptureFileOutputRecordingDelegate {
    ...
    func setupSession() -> Bool {
        ...
        guard setupSessionInputs() else {
            return false
        }
        
        guard setupSessionOutputs() else {
            return false
        }
    ...
    func setupSessionInputs() -> Bool {
        ...
        guard captureSession.canAddInput(videoInput) else { return false}
    ...
    func setupSessionOutputs() -> Bool {
        ...
        guard captureSession.canAddOutput(imageOutput) else {
            return false
        }
    ...
    func uniqueURL() -> URL {
        let tempUrl = NSTemporaryDirectory() + "kamera/" + "\(Int(Date().timeIntervalSince1970)).mov"
